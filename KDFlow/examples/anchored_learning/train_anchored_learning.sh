...
PACKING_SAMPLES=${PACKING_SAMPLES:-False}
...
TEACHER_FORWARD_N_BATCHES=${TEACHER_FORWARD_N_BATCHES:-10}
...
COMMON_DATA_OPTS+=" --packing_samples ${PACKING_SAMPLES}"
...
COMMON_TRAIN_OPTS+=" --attn_implementation ${ATTN_IMPLEMENTATION}"
COMMON_TRAIN_OPTS+=" --ring_attn_size ${RING_ATTN_SIZE}"
...
ANCHOR_OPTS+=" --teacher_forward_n_batches ${TEACHER_FORWARD_N_BATCHES}"
ANCHOR_OPTS+=" --enable_sleep ${ENABLE_SLEEP}"
